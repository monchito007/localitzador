...
var $visibility; // Visibilidad.
var $pressure; //Presión Atmosfèrica.
var $rising; // State of the barometric pressure: steady (0), rising (1), or falling (2). (integer: 0, 1, 2).

// WIND
var $wind_chill; // Frío viento en grados.
var $wind_direction; //Dirección del viendo en grados.
var $wind_velocity; //Velocidad del viendo km/h.

// UNITS
var $unit_temperature; // Unitat Temperatura.
var $unit_distance; // Unitat Distància.
var $unit_pressure; //Unitat pressió.
var $unit_speed; //Unitat Velocitat.
...
$this->fixurl = "http://weather.yahooapis.com/forecastrss?u=";
$this->fixurl = $this->fixurl . $this->unit . "&w=";
...
$this->fill_weather_atmosphere();
$this->fill_weather_wind();
$this->fill_weather_units();
...
// ------------------- 
// WEATHER ATMOSPHERE FILL
// -------------------
// *** Fill the weather wind *****************************
function fill_weather_atmosphere()
{
// RENEWED 19.11.2005 MAV : Rss of Yahoo changed
$this->humidity  =   $this->parser->output[0][child][0][child][9][attrs][HUMIDITY]; // OK
$this->visibility  =   $this->parser->output[0][child][0][child][9][attrs][VISIBILITY]; // OK
$this->pressure  =   $this->parser->output[0][child][0][child][9][attrs][PRESSURE]; // OK
$this->rising  =   $this->parser->output[0][child][0][child][9][attrs][RISING]; // OK
}
// ------------------- 
// WEATHER WIND FILL
// -------------------
// *** Fill the weather wind *****************************
function fill_weather_wind()
{
// RENEWED 19.11.2005 MAV : Rss of Yahoo changed
$this->wind_chill  =   $this->parser->output[0][child][0][child][8][attrs][CHILL]; // OK
$this->wind_direction  =   $this->parser->output[0][child][0][child][8][attrs][DIRECTION]; // OK
$this->wind_speed  =   $this->parser->output[0][child][0][child][8][attrs][SPEED]; // OK
}
// ------------------- 
// WEATHER UNITS FILL
// -------------------
// *** Fill the weather units *****************************
function fill_weather_units()
{
// RENEWED 19.11.2005 MAV : Rss of Yahoo changed
$this->unit_temperature  =   $this->parser->output[0][child][0][child][7][attrs][TEMPERATURE]; // OK
$this->unit_distance  =   $this->parser->output[0][child][0][child][7][attrs][DISTANCE]; // OK
$this->unit_pressure  =   $this->parser->output[0][child][0][child][7][attrs][PRESSURE]; // OK
$this->unit_speed  =   $this->parser->output[0][child][0][child][7][attrs][SPEED]; // OK
}
// ------------------- 
